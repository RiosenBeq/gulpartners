  ...
  return (
    <main className="pt-24 bg-surface text-primary font-sans antialiased">
      ...
      <section className="relative w-full h-[100vh] min-h-[800px] flex items-center overflow-hidden bg-[#0A0A0A]">
        ...
        <div className="absolute inset-0 z-1 bg-gradient-to-br from-secondary/30 to-transparent mix-blend-overlay"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-8 group relative overflow-hidden bg-surface-low p-10 border-l-[6px] border-secondary transition-all duration-700 hover:bg-surface hover:shadow-2xl">
            <div className="flex flex-col md:flex-row gap-10">
              ...
              <div className="w-full md:w-1/3 h-64 md:h-auto overflow-hidden relative group-hover:shadow-2xl transition-all duration-700">
                <img className="absolute inset-0 w-full h-full object-cover transition-all duration-1000 group-hover:scale-110" alt="Corporate Law" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAatluvpt5lkAhRQH0mTxIY4CeT9cKAewvNUjOSlp6sTeyGej1w-DG4gsSf7fjgsK9D1JC8mDSZl2p5NmC3U20RU37QZACkrFgD3bteLC_1VDd2cnxEDvM_pDzC-bIUgoGS97AyILGPcNhdDgek8nyPcdsLRAJ3oeov1suXoW4Uh2DCR0rLI2uNWvTFduV8Kn-Xmqwwe0xxCYcJH0_H4FkCjMRu_2tep4gKoIpOKBxep8XMYdCJNhWUAPreRj7OZn0lZ8BkuRmC6zo"/>
          ...
          <div className="md:col-span-4 relative group h-[400px] overflow-hidden bg-primary border border-outline-variant/10">
            <img className="absolute inset-0 w-full h-full object-cover opacity-70 transition-all duration-1000 group-hover:scale-110 group-hover:opacity-90" alt="Real Estate Law" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDpxXTz6OWl2FeQkkLEDScCFuckIF3y715UzavucQslwIGQEfVClZ0u6e8Q_ybOVIu41RhGCSOvg2_92Bv7OS6a6uwvmKDwTpW-lcfQOCvioKPB-rKjRtkZJgdm_KmBFCWM274VgfZktHnd4owqwI9-d4u_z0drciJ97vZ6sNCgkbmaxokFAkG7jlxXAKcjKpgqpQbaYBpYjMgr5FTeVSb2XPysruCWbCtP7hFCVX172lW0RfPsQrY8OFKhVRPAzyknjGsl5u2jnrY"/>
      ...
      <section className="bg-surface-low py-24 px-8 overflow-hidden border-t border-outline-variant/10">
        <div className="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <div className="relative overflow-hidden group">
            ...
            <img className="relative z-10 w-full shadow-2xl transition-all duration-1000 group-hover:scale-[1.03]" alt="Legal Process" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCInfF3asGOk9aDWgSlEyEX5KTBxDB2gWlg7MTmZj9MFYZTEU8OM2Mxkx1ma9XafFcISXyfETuMhfUvZpOn6v1pHfZETy3652ngPx5Zw6C9lQE3gN77F7UJxCv2I4c8eAbzgLk2UpyCRqUFGEny2Pjy9zHJDPKbPQ8nkZ8CVt7N0fo7gtjkBf80pMUgcMoJg_-L7TyooN8cz5tDbTiRxU8XjXnSyC6XvY25mYGNa3w7kOjODYwxSN7I7iVIaG5p8gzjeSsOUdUCdio"/>
          </div>
          <div>
